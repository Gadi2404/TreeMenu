        ...
        render: function (pages) {
            ...
            children.each(function () {
                ...
                if( data.pageType === 'first' )
                    $this.toggleClass(that.options.disabledClass, pages.currentPage < that.options.visiblePages - 1 );

                if( data.pageType === 'last' )
                    $this.toggleClass(that.options.disabledClass, pages.currentPage > (that.options.totalPages - that.options.visiblePages + 2) );
